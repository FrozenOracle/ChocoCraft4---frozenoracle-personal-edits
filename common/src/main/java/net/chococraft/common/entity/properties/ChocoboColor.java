...
public enum ChocoboColor {
	...
	GOLD(new ChocoboAbilityInfo().setSpeeds(50, 25, 25).setMaxHP(50).setStepHeight(2, 0.5f).setCanWalkOnWater(true).setCanClimb(true).setCanFly(true).setImmuneToFire(true)),
	PINK(new ChocoboAbilityInfo().setSpeeds(50, 25, 25).setMaxHP(50).setStepHeight(2, 0.5f).setCanClimb(true).setCanWalkOnWater(true).setCanFly(true)),
	RED(new ChocoboAbilityInfo().setSpeeds(50, 25, 25).setMaxHP(50).setStepHeight(2, 0.5f).setCanClimb(true).setCanWalkOnWater(true).setCanFly(true)),
	...
	FLAME(new ChocoboAbilityInfo().setSpeeds(40, 10, 20).setMaxHP(50).setStepHeight(1, 0.5f).setCanClimb(true).setCanFly(true).setImmuneToFire(true).addRiderAbility(() -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 100, -1, true, false)));
